#ifndef PADEL_MODE__TOURNAMENT_CHOOSE_PLAYERS_VIEW_H
#define PADEL_MODE__TOURNAMENT_CHOOSE_PLAYERS_VIEW_H
...
public:
    explicit PadelTournamentChoosePlayersView(
        Tournament &tournament,
        std::vector<UserProfile *> &players,
        const std::function<void(DeviceModeState)> &onDeviceModeChange,
        const std::function<void(PadelModeState)> &onStateChange
    )
    ...
    void renderEInkDisplay(EInkDisplay &einkDisplay) override {
        ...
        einkDisplay.showMenu(Str::MODE_OPTION_PADEL, rows, count, scrollable->getSelectedOptionId(),
...
#endif //PADEL_MODE__TOURNAMENT_CHOOSE_PLAYERS_VIEW_H
